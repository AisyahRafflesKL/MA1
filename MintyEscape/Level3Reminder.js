class Level3Reminder extends Phaser.Scene {
    ...
    showPage(pageNumber) {
        ...
        if (pageNumber === 1) {
            this.currentPageImage = this.add.image(game.config.width/2, game.config.height/2, 'Level3Reminder1');
        } else if (pageNumber === 2) {
            this.currentPageImage = this.add.image(game.config.width/2, game.config.height/2, 'Level3Reminder2');
            // Add ExcelMint sprite to page 2
            this.mintSprite = this.add.sprite(400, 320, 'excelMint')
                .setScale(3.5)
                .play('mintJump');
        } else if (pageNumber === 3) {
            this.currentPageImage = this.add.image(game.config.width/2, game.config.height/2, 'Level3Reminder3');
        } 
