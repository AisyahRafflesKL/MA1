class main extends Phaser.Scene {
  ...
  create() {
    ...
    // bg
    this.add
      .image(game.config.width / 2, game.config.height / 2, "mainScreen1")
      .setOrigin(0.5);

    this.add
      .image(game.config.width / 2, game.config.height / 2, "mainScreen2")
      .setOrigin(0.5);

    this.add
      .image(game.config.width / 2, game.config.height / 2, "mainScreen3")
      .setOrigin(0.5);

    this.bg1 = this.add
      .tileSprite(0, 0, game.config.width, game.config.height, "mainScreen1")
      .setOrigin(0, 0)
      .setScrollFactor(0);

    this.bg2 = this.add
      .tileSprite(0, 0, game.config.width, game.config.height, "mainScreen2")
      .setOrigin(0, 0)
      .setScrollFactor(0);

    this.bg3 = this.add
      .tileSprite(0, 0, game.config.width, game.config.height, "mainScreen3")
      .setOrigin(0, 0)
      .setScrollFactor(0);
    ...
    let playButton = this.add
      .text(game.config.width / 2, game.config.height / 2 + 145, "Play", {
        fontSize: "40px",
        fontFamily: "Hitchcut",
        fill: "#1A3449",
    ...
    let controlsButton = this.add
      .text(game.config.width / 2, game.config.height / 2 + 250, "Guide", {
        fontSize: "40px",
        fontFamily: "Hitchcut",
        fill: "#1A3449",
        backgroundColor: "#D1F2DE",
