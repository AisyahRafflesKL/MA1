...
// audio
  ...
  create() {
    ...
    //console.log(map); // Check if the map is loaded properly
...
this.cursors = this.input.keyboard.createCursorKeys();
    ...
    this.scoreBox = this.add
      .rectangle(480, 145, 255, 90, 0xffffff).setScale(0.7)
      .setScrollFactor(0); 
...
this.controlreminder = this.add.sprite(200, 600, "controlreminder").setScale(0.25); // Adjust position and scale as needed
this.controlreminder2 = this.add.sprite(1830, 600, "controlreminder2").setScale(0.25);
...
this.menuButton = this.add.text(100 + 80, 100+50, 'MENU', {
  fontSize: '25px',
  fontFamily: 'Hitchcut',
  fill: '#1A3449',
...
// this.homeButton = this.add.text(100 + 80, 150+40, 'Exit', {
//   fontSize: '20px',
//   fontFamily: 'Hitchcut',
//   fill: '#ffffff',
...
this.guideButton = this.add.text(100 + 80, 190+30, 'Guide', {
  fontSize: '20px',
  fontFamily: 'Hitchcut',
  fill: '#ffffff',
  backgroundColor: '#1A3449',
...
// this.exit = this.add.sprite(3102, 700, "exit")
//         .setScale(0.25)
//         .setDepth(100);
