...
// Restart text below mint requirement
this.restartText = this.add
  .text(game.config.width / 2, 170, "", {
    fontSize: "20px",
    fill: "#ffffff",
    fontFamily: "Hitchcut",
    backgroundColor: "red",
...
this.musicController = new MusicController(this);
  ...
  // Add this new function to check if player is away from trigger
  update() {
